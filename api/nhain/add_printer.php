...
$sql = "INSERT INTO printing_companies (company_name, tax_code, phone, email, city, district, ward, address, note) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $pdo->prepare($sql);
$stmt->execute([$company_name, $tax_code, $phone, $email, $city, $district, $ward, $address, $note]);

echo json_encode(['success' => true, 'message' => 'Nhà in đã được thêm thành công']);
?>
